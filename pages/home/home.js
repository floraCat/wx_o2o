var _shopping = {"data":require("../../apis/json/business/shopping/index.js").default};
Page({
  ...
  getList: function (catId) {
    ...
    // wx.showLoading({title: '加载中'})
  	// wx.request({
  	// 	url: getApp().globalData.httpHost + '/business/shopping/index' + getApp().globalData.suf,
  	// 	data: _opts,
    ...
    if (_num >= _info.goodsTypes[index2].inventory) {
      ...
      self.touchOnGoods(e, function () {
        ...
        if (!flag) { // 没此prodId
          ...
          _obj.area = _info.goodsTypes[index2].shopAddr
  ...
  searchSubmit: function (e) {
    ...
    wx.navigateTo({url: '/pages/search/search?keyword='+ _opt})
  },
  /*点击关键字*/
  // clickSearch: function (e) {
  //   let _opt = e.currentTarget.dataset.opt
